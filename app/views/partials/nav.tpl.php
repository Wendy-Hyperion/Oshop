<!-- <nav>
    <ul>
        <li><a href="<PHP md5(time()) PHP">404</a></li>
    </ul>
</nav> -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <a class="nav-link" href="<?= $router->generate('category') ?>">Categories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $router->generate('product') ?>">Produits</a>
                    </li>
                    <li class="nav-item">
